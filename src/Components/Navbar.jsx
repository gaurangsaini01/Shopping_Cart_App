...
function Navbar() {
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="flex justify-between py-2 w-full px-4 sm:px-0 xl:w-10/12 items-center text-white">
        <Link to="/">
        ...
        <div className="flex items-center  gap-8">
          ...
          <Link to="/cart">
            <div className="text-2xl  relative">
              ...
              <div className="hover:text-green-600 transition-all duration-200 ease-in"><FaCartShopping></FaCartShopping></div>
            </div>
          </Link>
        </div>
      </div>
